                ...
                <div key={index}>
                    ...
                    {category.children?.map((child, index) =>
                        <div key={index} className="flex flex-col items-start mt-2 space-y-4">
                            <Link href={`/category/${category.category.categoryId}/${child.category.categoryId}`} className="text-zinc-700 transition-colors duration-200 hover:underline hover:text-brand-500">
