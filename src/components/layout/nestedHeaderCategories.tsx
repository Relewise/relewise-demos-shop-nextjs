...
const Component = (props: NestedHeaderCategoriesProps) => {
    const [hoveredCategory, setHoveredCategory] = React.useState<CategoryHierarchyFacetResultCategoryNode | undefined>();

    const onMouseEnter = (category: CategoryHierarchyFacetResultCategoryNode) => setHoveredCategory(category);
