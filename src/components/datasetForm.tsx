    ...
    return (
        <div>
            <div className="bg-white rounded p-6">
                ...
                {contextStore.getAppContext().datasets.length > 0 &&
                    <div className="flex gap-3 items-center">
                        ...
                        <div className="flex-grow">
                            ...
                            <select value={contextStore.getAppContext().selectedDatasetIndex}
                                className="mb-6"
                                onChange={(e) => {
                                ...
                                {contextStore.getAppContext().datasets.map((dataset, index) =>
                                    <option key={dataset.datasetId} value={index}>{dataset.displayName ?? dataset.datasetId}</option>
                                )}
                            </select>
                        </div >
                ...
                <input value={dataset.displayName ?? ""} type="text" placeholder="Name" onChange={(e) => {
                ...
                <input value={dataset.datasetId ?? ""} type="text" placeholder="Dataset id" onChange={(e) => {
                ...
                <input value={dataset.apiKey ?? ""} type="text" placeholder="Api key" onChange={(e) => {
                ...
                <input value={dataset.language ?? ""} type="text" placeholder="LanguageCode" onChange={(e) => {
                ...
                <input value={dataset.currencyCode ?? ""} type="text" placeholder="CurrencyCode" onChange={(e) => {
                ...
                <input value={dataset.serverUrl ?? ""} type="text" placeholder="Server url" onChange={(e) => {
